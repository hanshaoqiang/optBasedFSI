...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [K_element, M_element, F_element] = computeElementStiffnessMatrixPlateInMembraneActionLinearCST(nodes,materialProperties,analysis,N)
...
%                  N : Shape function matrix on the gauss point.
%
%             Output :
%          K_element : The element stiffness matrix for the CST element
%          M_element : The element mass matrix for the CST element
%          F_element : The element body force vector for the CST element
%
% Function layout:
%
% 0. Read input
...
%% Compute the element mass matrix N'*N
% SFM =  Shape Function Matrix
SFM = [N(1),0,N(2),0,N(3),0;
       0,N(1),0,N(2),0,N(3)]; 

M_element = materialProperties.rho*(SFM'*SFM);


%% Compute the element body force vector. it should  be a 1x6 vector
F_element = materialProperties.rho*(materialProperties.bodyForce*SFM)';
