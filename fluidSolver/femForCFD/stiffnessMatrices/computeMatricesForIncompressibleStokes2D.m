...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [K,F] = computeMatricesForIncompressibleStokes2D(up, geometry, mesh, physics)
...
for i = 1:length(mesh.elements)
    ...
    for j = 1:physics.int.nGauss
        ...
        if strcmp(physics.stabilization.type,'variationalMultiscale')
            [KeOnGP,FeOnGP] = computeElementMatricesForIncompressibleStokes2DVMS(tau, physics, upe, uGp, N, dN, dDotN, laplaceN, Np, dNp);
        end
