...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function plot_referenceConfiguration(p,q,U,V,CP,rb,prb,F)
%% Function documentation
%
% Plots the geometry together with the boundary conditions and loads
% arrows. Works for both the isogeometric plate in membrane action and the
% vector convection-diffusion-reaction problems in 2D.
%
%   Input : 
