...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Fl = computeFluxLineVectorIncompressibleFlow2D(Fold,ub,vb,p,q,U,V,CP,int,hFlux,direction,t)
...
Fl = makeLoadToDofForIncompressibleFlow(F);
