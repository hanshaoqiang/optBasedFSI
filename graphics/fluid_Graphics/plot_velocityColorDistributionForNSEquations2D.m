...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function index = plot_velocityColorDistributionForNSEquations2D(mesh,up,graph)
...
for c_element=1:size(mesh.elements(:,1))
    ...
    for j=1:3
       ...
       scalarVelocityElement = sqrt(u.*u + v.*v);
    ...
    for j=1:grid_eta+2
        for i=1:grid_xi+2
            ...
            for k = 1:3
                scalarOverDomain(i,j) = scalarOverDomain(i,j) + N(k) * scalarVelocityElement(k);
            end
