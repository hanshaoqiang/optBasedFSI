...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [K_element, M_element] = computeElementStiffnessMatrixMeshMotionLinearCST(nodes,materialProperties,analysis,N)
...
if strcmp(analysis.physics,'plainStress')
    preFactor_material = (materialProperties.E*OneByDelta)/(1-materialProperties.nu^2);
...
elseif strcmp(analysis.physics,'plainStrain')
    preFactor_material = (materialProperties.E*OneByDelta)*(1-materialProperties.nu)/(1+materialProperties.nu)/(1-2*materialProperties.nu);
