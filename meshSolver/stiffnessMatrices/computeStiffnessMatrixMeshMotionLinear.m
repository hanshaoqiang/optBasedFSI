...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [K, M] = computeStiffnessMatrixMeshMotionLinear(mesh,materialProperties,analysis)
...
for i=1:length(mesh.elements)
    ...
    for gp = 1:analysis.int.nGauss
        ...
        [KeGp, MeGp ] = computeElementStiffnessMatrixMeshMotionLinearCST(nodes,materialProperties,analysis,gCord(:,:,gp));
